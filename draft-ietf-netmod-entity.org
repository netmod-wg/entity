...
the in "/hardware-state/component" list where the container "sensor-data"
exists is mapped to one EntPhySensorEntry.

-- YANG data nodes and related ENTITY-SENSOR-MIB objects
| YANG data node in /hardware-state/component/sensor-data | ENTITY-SENSOR-MIB object    |
|---------------------------------------------------------+-----------------------------|
...
-- YANG data nodes and related ENTITY-SENSOR-MIB objects
| YANG data node in /hardware-state/component/state | ENTITY-STATE-MIB object |
|---------------------------------------------------+-------------------------|
...
!! include-figure ietf-hardware.yang extract-to="ietf-hardware@2017-01-18.yang"

!! include-figure iana-hardware.yang extract-to="iana-hardware@2017-01-18.yang"
...
system component.
= /hardware-state/component/sensor-data/value:
